...
class wowhead_race extends wowhead
{
	...
	private $classes = array(
		443		=>	array('Death Knight', 'Mage', 'Paladin', 'Priest', 'Rogue', 'Warlock', 'Warrior'),	// human
		365		=>	array('Death Knight', 'Hunter', 'Rogue', 'Shaman', 'Warlock', 'Warrior'),			// orc 
		63		=>	array('Death Knight', 'Hunter', 'Paladin', 'Priest', 'Rogue', 'Warrior'),			// dwarf
		1085	=>	array('Death Knight', 'Druid', 'Hunter', 'Priest', 'Rogue', 'Warrior'),				// night elf
		441		=>	array('Death Knight', 'Mage', 'Priest', 'Rogue', 'Warlock', 'Warrior'),				// undead
		1125	=>	array('Death Knight', 'Druid', 'Hunter', 'Shaman', 'Warrior'),						// tauren
		425		=>	array('Death Knight', 'Mage', 'Rogue', 'Warlock', 'Warrior'),						// gnome
		253		=>	array('Death Knight', 'Hunter', 'Mage', 'Priest', 'Rogue', 'Shaman', 'Warrior'),	// troll
		446		=>	array('Death Knight', 'Hunter', 'Mage', 'Paladin', 'Priest', 'Rogue', 'Warlock'),	// blood elf

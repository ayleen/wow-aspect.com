...
$name 	=	(array_key_exists('name', $_GET))	? stripslashes(html_entity_decode($_GET['name'], ENT_QUOTES, "UTF-8"))	: '';
$region =	(array_key_exists('region', $_GET))	? stripslashes(html_entity_decode($_GET['region'], ENT_QUOTES, "UTF-8"))	: '';
$realm 	=	(array_key_exists('realm', $_GET))	? stripslashes(html_entity_decode($_GET['realm'], ENT_QUOTES, "UTF-8"))	: '';
